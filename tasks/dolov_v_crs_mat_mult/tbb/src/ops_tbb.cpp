...
DolovVCrsMatMultTbb::DolovVCrsMatMultTbb(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
}

bool DolovVCrsMatMultTbb::ValidationImpl() {
...
bool DolovVCrsMatMultTbb::PreProcessingImpl() {
  return true;
}

SparseMatrix DolovVCrsMatMultTbb::TransposeMatrix(const SparseMatrix &matrix) {
...
double DolovVCrsMatMultTbb::DotProduct(const SparseMatrix &matrix_a, int row_a, const SparseMatrix &matrix_b_t,
                                       int row_b) {
  double sum = 0.0;
...
bool DolovVCrsMatMultTbb::RunImpl() {
...
bool DolovVCrsMatMultTbb::PostProcessingImpl() {
  return true;
}
